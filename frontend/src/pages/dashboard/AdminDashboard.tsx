          ...
          <Grid container spacing={3} sx={{ mb: 3 }}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              {[
                ...
                >
                  <Box sx={{ display: "flex", alignsizes: "center", gap: 1.5 }}>
                    <Avatar
                      variant="rounded"
                      sx={{
                    ...
                    <Box sx={{ display: "flex", alignsizes: "center", gap: 2 }}>
                      <Typography
                        variant="subtitle2"
                        sx={{
                          fontWeight: 600,
                  ...
                  <Box sx={{ display: "flex", alignsizes: "center", gap: 0.5 }}>
                    <Button
                      size="small"
                      disableElevation
                      sx={{
          ...
          <Grid container spacing={3} sx={{ mb: 3 }}>
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    borderColor: "#3b82f6 #3b82f6 #a855f7 #a855f7",
                    display: "flex",
                    alignsizes: "center",
                    justifyContent: "center",
                  }}
            ...
            <Grid size={{ xs: 12, md: 3 }}>
              ...
              >
                ...
                <Typography
                  variant="caption"
                  sx={{ color: "#14b8a6", display: "block", mb: 1 }}
                >
            ...
            {[
              {
                ...
                meta: "Nil Yeager, 19 April",
                icon: "💻",
                color: "#eab308",
              },
              {
                title: "Live Drawing",
                meta: "Micak Doe, 12 June",
                icon: "🎨",
                color: "#0ea5e9",
              },
              {
                title: "Contemporary Art",
                meta: "Peter doe, 27 July",
                icon: "📚",
                color: "#ec4899",
              },
            ].map((lesson, i) => (
