          ...
          <Grid container spacing={3} sx={{ mb: 3 }}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              {[
                ...
                {
                  title: "Database Systems (MongoDB)",
                  instructor: "Tyler Mark",
                  progress: 90,
                  char: "M",
                  color: "#14b8a6",
                  btnColor: "#ccfbf1",
          ...
          <Grid container spacing={3} sx={{ mb: 3 }}>
            ...
            <Grid size={{ xs: 12, md: 3 }}>
              ...
              >
                ...
                <Typography
                  variant="caption"
                  sx={{ color: "#22c55e", display: "block", mb: 1 }}
                >
      ...
      <Grid container spacing={3} sx={{ mt: 1 }}>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          >
            ...
            {[
              {
                label: "React Assignment 2",
                value: 80,
                time: "2 days left",
                color: "#ef4444",
              },
              {
                label: "Database Normalization Quiz",
                value: 50,
                time: "5 days left",
                color: "#eab308",
              },
              {
                label: "Tailwind UI Redesign Portfolio",
                value: 10,
                time: "12 days left",
                color: "#22c55e",
              },
            ...
            {[
              {
                ...
                meta: "Course: Advanced React",
                icon: "💻",
                color: "#0ea5e9",
              },
              {
                title: "Grid vs Flexbox Layouts",
                meta: "Course: UI Principles",
                icon: "🎨",
                color: "#eab308",
              },
              {
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          >
            ...
            <List disablePadding sx={{ flexGrow: 1 }}>
              {[
                {
                  title: "Mid-Term Project Guidelines",
                  time: "Just Now",
                  desc: "Please view your assignment portals for evaluation criteria...",
                  color: "#a855f7",
                },
                {
                  title: "Server Maintenance Alert",
                  time: "Today",
                  desc: "LMS servers will undergo local updates at 12:00 AM...",
                  color: "#ef4444",
                },
                {
                  title: "New Evaluation Form Released",
                  time: "17 Dec 2025",
                  desc: "Teachers have updated assignment response criteria sheets...",
                  color: "#14b8a6",
                },
              ].map((notice, i) => (
                <ListItem
